package com.family.fmlgatewayserver.utils;
...
public class JWTUtil {
    ...
    static {
        try {
            ...
            //generateKeyPair();
            getInstanceForPub();/*初始化公钥config*/
            getInstanceForPri(); /*初始钥私钥config*/
        } catch (NoSuchAlgorithmException e) {
     ...
     * RSA公钥验签
     *
     * @param data 加密数据 jwt中的header+'.'+payload
     * @param sign 数字签名 = header+"."+payload+私钥的加密
     * @return 验签结果
     * @throws Exception
     */
